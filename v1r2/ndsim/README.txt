...
If you already have the software installed then modify the setup.sh
...
This application is controlled by an xml file in src/config/GeometryBuild.xml
This will create a .root file and a .gdml file
This will generate the geometry of the detector only, it won't put the detector in the cavity
