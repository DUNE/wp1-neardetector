...
#  REMOVE_FROM_LIST(root_flags "${root_libs_all}" "${root_library}")
  ...
  SET(ROOT_LIBRARIES ${root_flags} "-lEGPythia6 -lXMLIO")
...
MACRO (ROOT_GENERATE_DICTIONARY INFILES LINKDEF_FILE OUTFILE INCLUDE_DIRS_IN)
  ...
  MESSAGE("LD_LIBRARY_PATH is $ENV{LD_LIBRARY_PATH}")
...
#  MESSAGE("BLA: ${bla}")
  ...
  if (CMAKE_SYSTEM_NAME MATCHES Linux)
    ADD_CUSTOM_COMMAND(OUTPUT ${OUTFILES}
       #COMMAND LD_LIBRARY_PATH=${ROOT_LIBRARY_DIR}:/batchsoft/gcc/gcc-4.6.3-x86_64-sl6/lib64 ROOTSYS=${ROOTSYS} ${ROOT_CINT_EXECUTABLE}
