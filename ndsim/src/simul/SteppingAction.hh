...
class SteppingAction: public G4UserSteppingAction
{
 public:
  ...
  //bool particleSet(std::vector<GeantParticle> * particleVtr,int trackid);
  bool particleSet(std::vector<GeantParticle> particleVtr,int trackid);
  //bool findParent(GeantBasicParticle *p,TrackInformation * info);

  //getters
  //std::vector<GeantParticle> * getPrimariesVtrPtr()	{return primariesVtr;};
  //std::vector<GeantParticle> * getAllParticlesVtrPtr()	{return allPartcilesVtr;};
  std::vector<GeantParticle>  getPrimariesVtrPtr()	{return primariesVtr;};
  std::vector<GeantParticle>  getAllParticlesVtrPtr()	{return allPartcilesVtr;};
