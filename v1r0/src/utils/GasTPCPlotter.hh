...
class GasTPCPlotter {
 public:
  ...
  genie::NtpMCEventRecord* getGenieMCEventRecord() const {return fNtpMCEventRecordBuff_;}
  ...
  void setDataAddress(dataType* &dataObject, TTree* dataTree) {
    ...
    dataTree->GetBranch("gmcrec")->SetAddress(&fNtpMCEventRecordBuff_);
 ...
 protected:
  ...
  genie::NtpMCEventRecord * fNtpMCEventRecordBuff_;
