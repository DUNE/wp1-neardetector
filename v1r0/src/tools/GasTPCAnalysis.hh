...
double deltaSagitta, tpcresolution, magfield, angresolution, scintresolution, dedxCorMIP, dedxCorElec, gaspressure;

// The output tree variables
const Int_t kMaxTrack = 500;
Int_t EventID, RunID, ISTopology, FSTopology, neutPdg, neutcode, Target, NGeantHits[kMaxTrack], NGeantTracks, NCEcalTracks, TrackID[kMaxTrack], ParentID[kMaxTrack], Pdg[kMaxTrack], ParentPdg[kMaxTrack], LeftVolume[kMaxTrack];
Double_t FirstGeantHitPosition[kMaxTrack][4], LastGeantHitPosition[kMaxTrack][4], VertexPosition[4], x, y, Q2, W, weight, Enu, dEdx[kMaxTrack], RecondEdx[kMaxTrack], dEdxTruncated[kMaxTrack], RecondEdxTruncated[kMaxTrack], dEdxSigma[kMaxTrack], dEdxMuon[kMaxTrack], dEdxPion[kMaxTrack], dEdxElec[kMaxTrack], dEdxKaon[kMaxTrack], dEdxProt[kMaxTrack], pullmuon[kMaxTrack], pullpion[kMaxTrack], pullelec[kMaxTrack], pullkaon[kMaxTrack], pullprot[kMaxTrack];
...
Int_t NFSParticles, FSPdg[kMaxTrack],  NISParticles, ISPdg[kMaxTrack], ReconCharge[kMaxTrack], Charge[kMaxTrack];
