...
class DetectorConstruction : public G4VUserDetectorConstruction {
 public:
  DetectorConstruction(std::string geomFile, G4double magFieldStength, int necal, TGeoManager * geoMgr); 
  DetectorConstruction(std::string geomFile, G4double magFieldStength, int necal);
  ...
  // George
  ScintHitCollection * getScintHitCollection(int i);
  int getNumberOfScintHitCollection() {return scintSDVector_.size();};
