...
class ScintillatorSensitiveDetector : public G4VSensitiveDetector {
 public:
  ...
  //void setHitTrackCollectionPtr(scintTracks* h) {ScintSDHitTrackCollection = h;};
  //scintTracks* getHitTrackCollectionPtr() {return ScintSDHitTrackCollection;};
  ...
  //void SetEcalNumber(int ecalno)  {ecalNumber = ecalno;};
 ...
 private:
  ...
  //ScintHitCollection * ScintSDHitCollection;

  //scintTracks * ScintSDHitTrackCollection;
};
