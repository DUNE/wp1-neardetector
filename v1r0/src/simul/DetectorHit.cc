...
DetectorHit::DetectorHit() : G4VHit(){//, edep(0),nSteps(0),PDG(0), charge(0), pos(TLorentzVector()){
  edep = 0.0;
  nSteps = 0;
  PDG = 0;
  charge = 0;
...
DetectorHit::DetectorHit(G4VPhysicalVolume* pVol) {//: edep(0),nSteps(0),PDG(0), charge(0), pos(TLorentzVector()), prePhysVolume(pVol){
  edep = 0.0;
  nSteps = 0;
  PDG = 0;
  charge = 0;
