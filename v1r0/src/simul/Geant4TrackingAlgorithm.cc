...
void Geant4TrackingAlgorithm::initialize() {
  //detector geometry
  if(geoMgr_)detector_ = new DetectorConstruction(geomFile_,magFieldStrength_,necal_,geoMgr_);
  else detector_ = new DetectorConstruction(geomFile_,magFieldStrength_,necal_);
