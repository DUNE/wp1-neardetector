...
G4bool DetectorSD::ProcessHits(G4Step*aStep,G4TouchableHistory*) {
  ...
  //std::cout << "Local Time = " << thePrePoint->GetLocalTime() << " , Global time = " <<  thePrePoint->GetGlobalTime() << " , Proper time = " << thePrePoint->GetProperTime() << std::endl;
