...
\brief    A more convenient interface to the log4cpp Message Service
          Adappted from GENIE with permission from the authors.
...
\cpright  Copyright (c) 2003-2014, GENIE Neutrino MC Generator Collaboration
