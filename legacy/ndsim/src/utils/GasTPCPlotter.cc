...
GasTPCPlotter::GasTPCPlotter(bool initDataCards) : useMagFieldFromCard(false) {
  backTracerBuff_ = &backTracer_;
...
bool GasTPCPlotter::loadGeom(std::string filename){
...
void GasTPCPlotter::initDataCards() {
...
void GasTPCPlotter::loadDataCards() {
...
void GasTPCPlotter::getRunTimeArguments(int argc, char ** argv) {
