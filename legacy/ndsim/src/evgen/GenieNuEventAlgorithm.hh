...
class GenieNuEventAlgorithm {
 ...
 public:
  ...
  GasTPCGenieGeom*          getGeomDriver()  {return GasTPC_geom_driver_;}
  GasTPCGenieFlux*          getFluxDriver()  {return GasTPC_flux_driver_;}
...
private:
  ...
  GasTPCGenieGeom*               GasTPC_geom_driver_;
  GasTPCGenieFlux*               GasTPC_flux_driver_;
