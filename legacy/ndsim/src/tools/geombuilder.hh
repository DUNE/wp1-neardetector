...
std::string frootFilename, fgdmlFilename, ftpcmaterial, fVesselMaterial, fMagnetMaterial, fEcalMaterial, fRockMaterial;
double fdetectorYAxisOffset;
bool fbuildtpc, fbuildvessel, fbuildecal, fbuildrock, fbuildmagnet, fbuildcavity;
...
double fEcalLayers, fEcalThickness, fEcalGap, fEcalDensity;
