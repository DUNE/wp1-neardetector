...
\brief    Main program - Will generate neutrinos from input beam file and then track secondaries with geant
...
int main(int argc, char ** argv) {
  try {
    ...
    /// default values for all runtime parameters. - MUST BE POINTERS ON HEAP
