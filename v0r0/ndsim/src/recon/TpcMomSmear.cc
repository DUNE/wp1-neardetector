...
const double TpcMomSmear::getTrackLength(TVector3 first, TVector3 last){
...
const double TpcMomSmear::getTruthTransMomentum(TLorentzVector momentum){
...
const double TpcMomSmear::getTrackSagitta(double trackLength,double transMom){
...
const double TpcMomSmear::ccqeReconstruct(ParticleDescrShortRecord * protonTruthInfo,HitCollection &lepton,NeutrinoEvent* nu_event){
  ...
  TLorentzVector beamDir(0.,0.,1.,0.);
