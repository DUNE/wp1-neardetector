...
: G4VModularPhysicsList()
{
  ...
  currentDefaultCut   = 1.0*CLHEP::mm;
...
void EMCalcPhysicsList::ConstructProcess()
{
  ...
  emOptions.SetMaxEnergyForCSDARange(50*CLHEP::GeV);
...
{ 
  ...
  G4ProductionCutsTable::GetProductionCutsTable()->SetEnergyRange(100*CLHEP::eV, 1*CLHEP::GeV);
