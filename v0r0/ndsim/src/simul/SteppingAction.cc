...
SteppingAction::SteppingAction(G4double cutEnergy) 
  : rootGeoMgr_(NULL),eventID(0),/*geantID(0),particleEnterCount(0),particleLeaveCount(0),*/cutEnergy_(cutEnergy){

  Initialise();
}

SteppingAction::SteppingAction(TGeoManager * geoMgr,G4double cutEnergy) 
  : rootGeoMgr_(geoMgr),eventID(0),/*geantID(0),particleEnterCount(0),particleLeaveCount(0),*/cutEnergy_(cutEnergy){
