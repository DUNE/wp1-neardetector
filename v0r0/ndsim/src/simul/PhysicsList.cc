...
void PhysicsList::ConstructEM()
{
  ...
  G4LossTableManager::Instance()->SetMaxEnergy(1000*CLHEP::PeV);
...
void PhysicsList::ConstructHad(std::string hadlist) 
{
 ...
 if(hadlist.find("FTFP_BERT_HP") != std::string::npos){
    ...
    G4HadronElasticPhysics*  HadronElasticPhysics = new G4HadronElasticPhysics(VerboseLevel); // george
    ...
    //G4ElasticHadrNucleusHE* elastic_he = new G4ElasticHadrNucleusHE();//george
