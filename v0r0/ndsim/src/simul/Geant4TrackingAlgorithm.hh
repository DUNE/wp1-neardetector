...
class Geant4TrackingAlgorithm {
 public:
  ...
  //void setGeometryFile(std::string geomFile) {geomFile_ = geomFile;};
  //void setTargetVolumeName(std::string targetVolName){targetVolName_ = targetVolName;};
  ...
  //void dopiZeroTracker(bool piZeroTracker) {piZeroTracker_= piZeroTracker;};
  //void doParticleGun(bool runGunMacro) {runGunMacro_ = runGunMacro;};
